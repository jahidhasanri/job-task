  ...
  return (
    <div className="xl:max-w-360 mx-auto">
      ...
      <div className="lg:flex gap-6">
        {/* Image Section */}
        <div className="bg-[#FFFAFA] mb-5 xl:ml-57.25 xl:mr-8 xl:w-132.75 xl:h-120.25 rounded-lg flex justify-center items-center p-10">
          <Image
            src={product.image}
            alt={product.name}
            width={446}
      ...
      <div className="lg:flex items-center gap-6 xl:mt-19.25 xl:mb-12">
            {/* Quantity */}
