...
export default function ProductDetailPage() {
  ...
  return (
    <div className="xl:max-w-360 mx-auto ">
        <div className='flex xl:mt-9.5 xl:ml-30.25 gap-3 text-gray-500 xl:w-100.75 xl:h-5.25 xl:mb-18.25'>
                <h1>Account</h1>
                <span>/</span>
                <h1>Electronics</h1>
                <span>/</span>
      ...
      <div className="grid xl:grid-cols-2 gap-10">
        ...
        {/* Image Section */}
        <div className="bg-[#F5F5F5] rounded-lg flex justify-center items-center p-10">
          <Image
            src={product.image}
            alt={product.name}
            width={420}
