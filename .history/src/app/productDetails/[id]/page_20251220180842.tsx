...
export default function ProductDetailPage() {
  ...
  <button
    className="w-6 h-6 rounded-full bg-black border-2 border-gray-400 focus:ring-2 focus:ring-black"
    aria-label="Black color"
  ></button>

  <button
    className="w-6 h-6 rounded-full bg-gray-400 border-2 border-gray-400 focus:ring-2 focus:ring-gray-500"
    aria-label="Gray color"
  ></button>
</div>

            {/* Size (Optional / Dynamic Ready) */}
            {product.size && (
