...
export default function ProductDetailPage() {
  ...
  return (
    <div className="xl:max-w-360 mx-auto">
      ...
      {/* Main Section */}
      <div className="lg:flex gap-6 mx-2 lg:mx-4 xl:mx-0">
        {/* Image Section */}
      ...
      <div className="lg:flex lg:mb-8  items-center gap-6 xl:mt-19.25 xl:mb-12 mx-5 xl:mx-0">
            {/* Quantity */}
  ...
  {[92, 29, 18, 8, 4].map((value, index) => (
    <div key={index} className="flex items-center gap-4">
      ...
      <div className="text-[22px] mx-2  mb-3.75 xl:w-287.25 lg:w-200 lg:mx-auto xl:h-14.5 md:flex items-center border border-black">
...
<div className="grid xl:grid-cols-4 md:grid-cols-2 relative gap-7.5 xl:w-292.5 mx-auto ">
  {products.slice(8, 12).map((product) => {
    ...
    return (
      <div
        key={product.id}
        className="relative flex flex-col rounded-lg mx-2 xl:mx-0 "
      >
        {/* Discount Badge */}
