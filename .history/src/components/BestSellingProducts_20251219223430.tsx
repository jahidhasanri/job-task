    ...
    <div className="xl:max-w-292.5 mx-auto">
      {/* Best Selling Products */}
        ...
        <div className="xl:max-w-100 ">
          <h3 className="text-xl align-text-bottom xl:text-[36px] font-semibold tracking-[0.03em]">
            Best Selling Products
          </h3>
        </div>

        <div className="flex gap-2">
          <button className="w-39.75 h-14 bg-[#0F59B9] font-medium text-[16px] rounded-[5px] text-white">View All</button>
        </div>
      </div>


        <div className="xl:max-w-99 h-2.75 bg-[#1163CF]  mb-19.5" />
