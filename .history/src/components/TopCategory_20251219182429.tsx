...
export function TopCategory() {
  ...
  return (
    <section className="mx-auto xl:max-w-[315.5rem] lg:max-w-full xl:mt-40 px-4 xl:px-0">
      
      {/* ---------- Header ---------- */}
      <div className="flex items-center justify-between">
        <div className="xl:max-w-[115.75rem]">
          <h3 className="text-xl xl:text-[36px] font-semibold tracking-[0.05em]">
            Shop From{" "}
      ...
      <div className="xl:w-[113.5rem] h-[2.75rem] bg-[#1163CF] mt-4 mb-20" />
      ...
      <hr className="xl:mt-15 xl:mb-12" />
    </section>
  )
}
