  ...
  return (
    <div className="relative flex-1">
      <div className="relative h-80 md:h-90 lg:h-100.5 xl:h-118  bg-linear-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex items-center px-6 md:px-12">
        ...
        <div className="w-full md:max-w-40 lg:max-w-60 xl:max-w-100 mt-16">
          ...
          <button className="rounded-full mt-14 bg-[#210af5] ml-14 w-35 h-12.5 text-white font-semibold">Shop Now</button>
        </div>
