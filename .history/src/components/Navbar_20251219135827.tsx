...
const Navbar = () => {
  ...
  <div
    className="
      mx-auto flex max-w-7xl lx:max-w-313.75 items-center justify-center gap-2md:justify-between md:px-2 xl:px-0"
  >
    {/* Email */}
    <p
      className="text-[16px] xl:w-68.75 flex items-center justify-center gap-1 py-3 text-center"
    >
      <MdEmail />
    ...
    {/* Social Icons */}
    <div
      className="hidden md:flex xl:w-52 items-center justify-center gap-4 py-4"
    >
      <Link href="#"><RiFacebookLine className="w-6 h-6" /></Link>
      <Link href="#"><FaTwitter className="w-6 h-6" /></Link>
      <Link href="#"><IoLogoInstagram className="w-6 h-6" /></Link>
