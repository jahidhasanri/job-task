  ...
  return (
    <div className="relative flex-1">
      <div className="relative h-80 md:h-90 lg:h-100.5 xl:h-120  bg-linear-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex items-center ">
        ...
        <div className="w-full md:max-w-40 border lg:max-w-60 xl:max-w-105.25 xl:h-30.75 xl:mt-10.75 xl:mb-5.5 xl:ml-16.75">
        ...
        {/* DOT INDICATORS */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 mb-4">
          {slides.map((_, index) => (
            <button
              key={index}
