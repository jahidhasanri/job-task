...
const Navbar = () => {
  ...
  <div className="border-b bg-white mx-auto">
    <div className="flex flex-col md:flex-row items-start md:gap-7 xl:gap-0 md:items-center text-sm font-medium">
      <div className="lg:w-auto w-full md:max-w-54.75 lg:max-w-65 flex justify-center lg:justify-start xl:max-w-74.75 border xl:mr-12 mb-2 lg:mb-0">
