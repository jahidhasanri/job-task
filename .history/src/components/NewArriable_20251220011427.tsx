...
const NewArriable = () => {
    return (
       ...
       <div className="xl:w-57 h-2.75 bg-[#1163CF] mt-9 mb-13 ml-2" />
         ...
         <div className="flex gap-7.5 xl:max-w-285 xl:h-161.75 ml-6">
  
  {/* Left Image */}
  <div className="border  h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n3 1.png"
      alt=""
      width={656}
  ...
  {/* Right Image */}
  <div className="border w-full h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n2 1.png"
      alt=""
      width={454}
