...
export function TopCategory() {
  ...
  return (
    <section className="mx-auto xl:max-w-315.5 mt-10 lg:max-w-313 border md:mt-16 lg:mt-20 px-4">
      {/* Header */}
      <div className="mb-6 flex items-center justify-between">
        <div className="xl:max-w-115.75 border">
            <h3 className="text-xl font-semibold w-full xl:text-[36px] ">
          Shop From <span className="text-blue-600 text-[36px] font-semibold">Top Category</span>
        </h3>
        </div>
