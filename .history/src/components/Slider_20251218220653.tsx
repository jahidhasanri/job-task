    ...
    <div className="relative flex-1">
      <div className="relative h-80 rounded-lg bg-linear-to-r from-cyan-400 to-blue-300 overflow-hidden flex items-center px-6 md:px-12">
        ...
        <div className="max-w-100">
          <h2 className="text-3xl lett tracking-[0.04em] sm:text-4xl md:text-6xl lg:text-[40px] text-center leading-14 font-bold text-pink-600 mb-5">
            {slide.title}
          </h2>
        </div>
          
          <p className="text-sm lg:text-[32px] font-semibold text-white text-center md:text-base max-w-100">
            {slide.desc}
          </p>
