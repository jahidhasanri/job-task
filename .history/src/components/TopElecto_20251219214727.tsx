...
>
  ...
  {/* Card 3 */}
  <div
    className=" bg-cover bg-center  xl:w-98 h-54.25 "
    // style={{ backgroundImage: "url('/2 10.png')" }}
  >
    <div className="bg-[#ffe5c2]">
      <h2 className="text-xl xl:text-[24px] font-bold xl:w-48.75 xl:h-26.5 border xl:mt-15.75 xl:ml-4 text-black ">10% Off On Iphone series</h2>
    </div>
    <div className=''>
        <Image src="/2 10.png" className=' mt-4.25' alt=""  width={218} height={200}/>
    </div>
  </div>
</div>
