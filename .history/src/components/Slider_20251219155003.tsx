  ...
  return (
    <div className="relative flex-1">
      <div className="relative h-80 md:h-90 lg:h-100.5 xl:h-120  bg-linear-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex items-center ">
        ...
        <div className="w-full md:max-w-40 border lg:max-w-60 xl:max-w-105.25 xl:h-30.75 xl:mt-15.75 xl:mb-5.5 xl:ml-16.75">
          ...
          <p className="text-sm lg:text-[32px] border ml-3 font-semibold text-white text-center md:text-base xl:max-w-115.5 xl:mb-13.5 xl:ml-13">
            {slide.desc}
          </p>
          <button className="rounded-full  bg-[#210af5] xl:ml-25 xl:w-35 xl:h-12.5 text-white font-semibold">Shop Now</button>
        </div>
