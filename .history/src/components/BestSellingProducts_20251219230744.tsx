  ...
  return (
    <div className="xl:max-w-292.5 mx-auto">
      ...
      <div className="grid xl:grid-cols-4 md:grid-cols-2 gap-7.5">
        ...
        {/* Image Zoomed */}
        <div className="w-full flex justify-center border items-center h-full overflow-hidden">
          <Image
            src={product.image}
            alt={product.name}
            width={190}
            height={180}
            className="scale-120 object-contain transition-transform duration-300 border mx-10 mt-5.5 mb-1.75"
          />
        </div>
        <Link
