  ...
  >
    ...
    >
      ...
      <div className="border-b bg-white max-w-360 mx-auto">
        <div className=" flex items-center justify-between gap-3 pt-5.75 pb-6 ">
          
          {/* Left Logo */}
          <div className="xl:w-29.5 xl:ml-17.25 xl:mr-14.5">
          <Link href="/" className="text-2xl  border justify-start font-bold text-blue-600 xl:mr-15">
            BuyBee
          </Link>
          </div>

          {/* Center: Search (Desktop only) */}
          <div className="hidden xl:w-208.5 xl:mr-8.25 border lg:flex flex-1 items-center">
            <Input
              placeholder="Search Items here......"
              className="rounded-r-none"
            />
          ...
          {/* Right: Icons */}
          <div className="flex items-center xl:w-70.25 xl:mr-11.75 border gap-4 ml-7.5">
