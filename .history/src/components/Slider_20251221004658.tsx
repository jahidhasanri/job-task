...
export function Slider() {
  ...
  return (
    <div className="relative flex-1">
      <div className="relative bg-gradient-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex flex-col md:flex-row items-center md:items-start justify-between h-auto md:h-96 lg:h-[500px] xl:h-[600px] px-4 md:px-8 lg:px-16 py-8">

        {/* LEFT CONTENT */}
        <div className="flex flex-col md:w-1/2 order-1 md:order-1 items-center md:items-start space-y-4 md:space-y-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#ff36bc] text-center md:text-left leading-snug">
            {slide.title}
          </h2>
        ...
        {/* RIGHT IMAGE */}
        <div className="md:w-1/2 flex justify-center md:justify-end order-2 md:order-2 mt-6 md:mt-0">
          <Image
            src={slide.img}
            alt="slide image"
            width={550}
            height={700}
            className="w-48 sm:w-64 md:w-80 lg:w-96 xl:w-[550px] h-auto object-contain"
          />
        </div>
