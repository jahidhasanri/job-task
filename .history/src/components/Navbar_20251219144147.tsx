...
const Navbar = () => {
  ...
  >
    ...
    <div
      className="
        hidden  md:flex  xl:w-52  items-center  justify-center xl:mr-24.75 gap-4 py-4 border
      "
    >
      <Link href="#"><RiFacebookLine className="w-6 h-6" /></Link>
      <Link href="#"><FaTwitter className="w-6 h-6" /></Link>
      ...
      {/* Main Navbar */}
     <div className="border-b bg-white max-w-360 border mx-auto">
  <div className="flex flex-wrap xl:flex-nowrap items-center justify-between gap-3 pt-5.75 pb-6 px-4 xl:px-0">
    ...
    <div className="flex border items-center xl:w-29.5 xl:ml-17.25 xl:mr-14.5">
      <Link
        href="/"
        className="text-2xl font-bold text-blue-600 xl:mr-15"
      >
        BuyBee
      </Link>
    </div>
    ...
    <div className="hidden lg:flex border flex-1 items-center xl:w-208.5 xl:mr-8.25">
      <Input
        placeholder="Search Items here......"
        className="rounded-r-none"
      />
    ...
    {/* Right Icons */}
    <div className="flex items-center border gap-4 ml-auto xl:w-70.25 xl:mr-11.75 xl:ml-7.5">
