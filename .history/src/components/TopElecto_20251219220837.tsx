...
>
  ...
  {/* Card 3 */}
   <div className="flex items-center justify-between bg-[#FFE5C2] w-98 h-54.25 rounded-md px-6">
      <h2 className="text-black xl:mt-15.75 font-bold text-[24px] leading-tight max-w-170">
      ...
      <div className="shrink-0 xl:h-55">
        <Image
          ...
          width={180}
          height={250}
          className="object-cover h-full mr-.75"
        />
      </div>
