...
export function Slider() {
  ...
  return (
    <div className="relative flex-1">
      <div className="relative h-80 md:h-90 lg:h-100.5 xl:h-120  bg-linear-to-r from-[#87d1dc] to-blue-300 overflow-hidden md:flex items-center ">

        {/* LEFT CONTENT */}
        <div className="w-full md:w-1/2 space-y-3">
        <div className="w-full md:max-w-40 mb-1 lg:max-w-60 xl:max-w-105.25 xl:h-30.75 xl:mt-10.75 xl:mb-5.5 xl:ml-16.75">
          <h2 className="text-2xl mt-8 xl:mt-0 lett md:tracking-[0.04em] sm:text-4xl md:text-6xl lg:text-[40px] text-center leading-14 font-bold text-[#ff36bc] ">
            {slide.title}
          </h2>
        </div>
        ...
        {/* RIGHT IMAGE */}
        <div className="w-full md:w-1/2 md:flex border md:justify-start">
          <Image
            src={slide.img}
            alt="slide image"
            width={550}
            height={700}
            className="object-contain md:w-50 sm:w-75 md:w-100 lg:w-125 xl:w-137.5 h-auto mt-8 md:mt-174 lg:mt-22 xl:mt-29"
          />
        </div>
