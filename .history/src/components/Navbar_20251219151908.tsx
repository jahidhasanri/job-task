...
const Navbar = () => {
  ...
  {/* Top Bar */}
  <div className="bg-blue-600 text-white text-xs md:text-sm max-h-15 overflow-hidden">
    <div className="mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 md:px-2 xl:px-0 border">
      {/* Email */}
      <p className="text-[16px] xl:w-68.75 flex items-center justify-center gap-1 py-3 text-center border xl:ml-21.5">
        <MdEmail /> Email: support@buybee.com
      </p>

      {/* Social Icons */}
      <div className="hidden md:flex xl:w-52 items-center justify-around xl:mr-24.75 gap-4 py-4 border">
        <Link href="#"><RiFacebookLine className="w-6 h-6" /></Link>
        <Link href="#"><FaTwitter className="w-6 h-6" /></Link>
        <Link href="#"><IoLogoInstagram className="w-6 h-6" /></Link>
        <Link href="#"><FaLinkedinIn className="w-6 h-6" /></Link>
  ...
  <div className="border-b bg-white mx-auto">
    <div className="flex flex-col lg:flex-row items-start lg:items-center text-sm font-medium">
      <div className="lg:w-auto w-full md:max-w-44.75 flex justify-center lg:justify-start xl:max-w-74.75 border xl:mr-12 mb-2 lg:mb-0">
