...
const NewArriable = () => {
    return (
       ...
       <div className="flex gap-7.5 xl:max-w-286 xl:h-161.75 ml-6">

  {/* Left Image */}
  <div className="border w-[165.5px] h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n3 1.png"
      alt=""
      width={662}
  ...
  {/* Right Image */}
  <div className="border w-[113px] h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n2 1.png"
      alt=""
      width={452}
