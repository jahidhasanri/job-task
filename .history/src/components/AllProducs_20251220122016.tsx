...
export default function AllProducts() {
  ...
  return (
    <section className="xl:max-w-327.5 mx-auto xl:pb-15.5 border px-4 xl:mt-18.75">
...
<Button
  size="icon"
  className="w-11.5 h-11.5 rounded-full bg-[#f5f5f5] -bottom-10 xl:ml-308 shadow-lg"
  variant="outline"
>
