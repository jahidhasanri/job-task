...
const ContactPage = () => {
  ...
  return (
    <div className="flex items-center justify-center px-4 sm:px-6 md:px-8 xl:px-0 py-10">
      <div className="w-full sm:w-3/4 md:w-2/3 xl:w-auto rounded-xl">
        <h1 className="text-2xl sm:text-3xl text-center font-medium xl:mt-10 mb-10 sm:mb-12 md:mb-14">
