...
>
  ...
  {/* Card 3 */}
   <div className="flex  bg-[#FFE5C2] w-98 h-54.25 rounded-md ">
      <div className='xl:w-42.5 xl:ml-4.25'>
      <h2 className="text-black  font-bold text-[23px] xl:mt-15.75 leading-tight max-w-168">
      ...
      <div className="shrink-0 xl:h-55">
        <Image
          ...
          width={170}
          height={250}
          className="object-cover h-full mr-10"
        />
      </div>
