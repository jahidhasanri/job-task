...
const TopElecto = () => {
  ...
  {/* Card 2 */}
  <div
    className=" bg-cover bg-center  xl:w-98 h-54.25 md:flex bg-[#FFCABA]"
>
    <div className="text-white">
      <h2 className="text-xl mt-10 mx-2 xl:text-[23px] font-bold xl:w-48.75 xl:h-26.5 xl:mt-15.75 xl:ml-4 text-[#DA1919] ">10% Off On Apple Mackbook series</h2>
    </div>
    <div className=''>
  ...
  {/* Card 3 */}
   <div className="flex  bg-[#FFE5C2] xl:w-98 h-54.25  ">
