...
const Navbar = () => {
  ...
  return (
    <header className="w-full">
      ...
      {/* Main Navbar */}
      <div className="border-b bg-white">
        <div className="mx-auto flex max-w-7xl lg:max-w-350 items-center justify-between gap-3 px-4 py-5">
          
          {/* Left Logo */}
          <Link href="/" className="text-2xl lg:max-w-29.5 font-bold text-blue-600 lg:mr-15">
            BuyBee
          </Link>
          ...
          {/* Right: Icons */}
          <div className="flex items-center gap-4 ml-7.5">
            <Link href="#" className="hidden lg:flex items-center gap-1 text-sm lg:mr-5">
              <User className="h-8 w-8" />
              <span className="text-[12px] mt-3">Sign In</span>
            </Link>
            <Link href="#" className="hidden lg:flex items-center gap-1 text-sm lg:mr-5">
