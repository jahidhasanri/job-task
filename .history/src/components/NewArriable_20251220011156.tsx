...
const NewArriable = () => {
    return (
       ...
       <div className="xl:w-57 h-2.75 bg-[#1163CF] mt-9 mb-13 ml-2" />
         ...
         <div className='flex gap-7.5 xl:max-w-285 xl:max-h-161.75 ml-6'>
            <div className='border'>
                <Image src="/n3 1.png" className=' mt-4.25' alt=""  width={656} height={674}/>
            </div>
            <div className='border'>
                <Image src="/n2 1.png" className=' mt-4.25' alt=""  width={454} height={674}/>
            </div>
         </div>
