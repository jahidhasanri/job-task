...
export default function AllProducts() {
  ...
  const processedProducts = [...productsAll]
    .filter((p) => {
  ...
  return (
    <section className="xl:max-w-327.5 mx-auto xl:pb-15.5 px-4 xl:mt-18.75">
      ...
      {/* Products Grid */}
      <div className="grid xl:grid-cols-4 md:grid-cols-2 gap-7.5 xl:w-292.5 mx-auto ">
        {processedProducts.map((product) => {
          ...
          return (
            <div
              key={product.id}
              className="relative flex flex-col border rounded-lg xl:mb-15"
            >
              {/* 🔴 Discount Badge */}
  ...
  <button className="w-39.75 h-14 xl:-mt-10 bg-[#0F59B9] flex justify-center items-center cursor-pointer text-white text-[16px] font-medium rounded-[5px]">
    View All
  </button>
</div>
