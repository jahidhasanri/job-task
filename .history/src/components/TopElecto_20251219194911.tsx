...
const TopElecto = () => {
  ...
  {/* Card 1 */}
  <div
    className="flex border items-center bg-[url('/4 1.png')] bg-cover bg-center w-full xl:w-96.5 h-50 p-4"
  >
  ...
  {/* Card 2 */}
  <div
    className="flex border items-center bg-[url('/3 1.png')] bg-cover bg-center w-full xl:w-97 h-50 p-4"
  >
    <div className="text-white">
  ...
  {/* Card 3 */}
  <div
    className="flex border items-center bg-[url('/2 10.png')] bg-cover bg-center w-full xl:w-97 h-50 p-4"
  >
    <div className="text-white">
