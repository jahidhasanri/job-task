...
>
  ...
  {/* Card 3 */}
   <div className="flex items-center justify-between bg-[#FFE5C2] w-[392px] h-[217px] rounded-md px-6">
      
      {/* Left Content */}
      <h2 className="text-black font-bold text-[24px] leading-tight max-w-[170px]">
