...
const Navbar = () => {
  ...
  return (
    <header className="w-full">
      ...
      {/*  Bottom Menu  */}
      <div className="border-b bg-white max-w-375 mx-auto">
        
        <div className=" hidden  items-center gap-6 px-4 py-3 text-sm font-medium md:flex">
          <div>
          ...
          <div>
            <nav className="flex gap-6 max-w-220">
