...
export function Slider() {
  ...
  <div className="relative bg-linear-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex flex-col md:flex-row items-center md:items-start justify-between 
                  h-100 sm:h-112.5 md:h-125 lg:h-137.5 xl:h-150 px-4 md:px-8 lg:px-16 py-8">
    {/* LEFT CONTENT */}
