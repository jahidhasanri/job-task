...
const Navbar = () => {
  ...
  return (
    <header className="w-full">
      {/*  Top Bar */}
      <div className="bg-blue-600 text-white text-xs md:text-sm max-h-15 overflow-hidden">
        <div className="mx-auto flex max-w-7xl lx:max-w-313.75 items-center justify-between ">
          <p className="text-[16px] text-center xl: w-68.75 flex items-center gap-1 pt-3 pb-5.5"><MdEmail /> Email: support@buybee.com</p>

          <div className="hidden md:flex xl:w-52 items-center font-normal gap-4 pt-4.5 pb-4.5">
            <Link href="#"><RiFacebookLine  className="w-6 h-6"/></Link>
            <Link href="#"><FaTwitter className="w-6 h-6" /></Link>
            <Link href="#"><IoLogoInstagram className="w-6 h-6" /></Link>
            <Link href="#"><FaLinkedinIn className="w-6 h-6" /></Link>
