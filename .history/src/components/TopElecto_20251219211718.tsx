...
>
    <div className="text-white">
      <h2 className="text-xl xl:text-[24px] font-bold xl:w-48.75 xl:h-26.5 border xl:mt-15.75 xl:ml-4 text-[#DA1919] -tracking-widest">10% Off On Apple Mackbook series</h2>
    </div>
    <div>
