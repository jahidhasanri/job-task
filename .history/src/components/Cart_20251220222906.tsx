...
export default function Cart() {
  ...
  return (
    <div className="xl:max-w-360 mx-auto ">
      <div className="xl:w-25.75 xl:h-5 border xl:ml-139.25 xl:mt-10.75">
      <h1 className=" text-[14px] font-normal mb-25.5 text-black"><span className="text-gray-500 ml-2">Home </span>  / <span>Cart</span></h1>
      </div>
