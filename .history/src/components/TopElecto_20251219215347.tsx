...
>
  ...
  {/* Card 3 */}
  <div
    className="bg-[#ffe5c2] flex xl:w-98 h-54.25 relative"
    // style={{ backgroundImage: "url('/2 10.png')" }}
  >
    <div className="">
      <h2 className="text-xl xl:text-[24px] font-bold xl:w-46.75 xl:h-19.5 border xl:mt-15.75 xl:ml-4.25 text-black ">10% Off On Iphone series</h2>
    </div>
    <div className=''>
        <Image src="/2 10.png" className=' mr-10 border h-full absolute' alt=""  width={289} height={216}/>
    </div>
  </div>
</div>
