...
export function Slider() {
  ...
  <div className="relative bg-gradient-to-r from-[#87d1dc] to-blue-300 overflow-hidden flex flex-col md:flex-row items-center md:items-start justify-between 
                  h-[400px] sm:h-[450px] md:h-[500px] lg:h-[550px] xl:h-[600px] px-4 md:px-8 lg:px-16 py-8">
    {/* LEFT CONTENT */}
    ...
    <div className="md:w-1/2 flex justify-center md:justify-end order-2 md:order-2 mt-6 md:mt-0 h-full">
      <Image
        ...
        width={550}
        height={700}
        className="w-48 sm:w-64 md:w-80 lg:w-96 xl:w-[550px] h-full object-contain"
      />
    </div>
