...
const Navbar = () => {
  ...
  >
    ...
    <p
      className="
        text-[16px] xl:w-68.75 flex items-center justify-center gap-1 py-3 text-center border xl:ml-21.5
      "
    >
      <MdEmail />
    ...
    <div
      className="
        hidden  md:flex  xl:w-52  items-center  justify-around xl:mr-24.75 gap-4 py-4 border
      "
    >
      <Link href="#"><RiFacebookLine className="w-6 h-6" /></Link>
      <Link href="#"><FaTwitter className="w-6 h-6" /></Link>
      ...
      {/* Main Navbar */}
     <div className="border-b bg-white  border mx-auto">
  <div className="flex flex-wrap xl:flex-nowrap items-center justify-between gap-3 pt-5.75 pb-6 px-4 xl:px-0">
    
    {/* Left Logo */}
    <div className="flex border items-center xl:w-29.5 xl:ml-17.25 xl:mr-14.5">
      <Link
        href="/"
    ...
    <div className="hidden lg:flex border flex-1 items-center xl:w-208.5 xl:mr-8.25 relative">
      <Input
        placeholder="Search Items here......"
        className="rounded-r-none"
      />
    ...
    {/* Right Icons */}
    <div className="flex items-center border gap-6 justify-around ml-auto xl:w-80.25 xl:mr-11.75 ">
      
      {/* Sign In */}
      <Link
        href="#"
        className="hidden lg:flex items-center gap-1 text-sm xl:mr-5"
      >
        <User className="h-8 w-8" />
  ...
  <div className="px-4 pb-4 lg:hidden">
    <div className="flex gap-2">
      ...
      {/*  Bottom Menu */}
      <div className="border-b border bg-white  mx-auto">
        <div className="flex flex-col lg:flex-row items-start lg:items-center  text-sm font-medium ">

          <div className=" lg:w-auto flex justify-center lg:justify-start xl:max-w-74.75 border xl:mr-12 mb-2 lg:mb-0">
            ...
            <div className="xl:mr-71 xl:w-219.75 border">
  <div className="w-full mx-auto flex flex-col lg:flex-row justify-center gap-4 lg:gap-10 text-center">
    <Link href="/" className="text-blue-600 font-medium text-[15px]">Home</Link>
    <Link href="/contact" className="text-blue-600 font-medium text-[15px]">Contact</Link>
    <Link href="/products" className="text-blue-600 font-medium text-[15px]">Products</Link>
    <Link href="/offers" className="text-pink-500 font-medium text-[15px]">Hot Offers</Link>
