...
const Register = () => {
  ...
  return (
    <div className="xl:w-92.75 xl:h-132.5 mx-auto flex flex-col justify-center xl:ml-138.5">
      {/* Title */}
      ...
      <Button
        ...
        className="bg-blue-600 hover:bg-blue-700 w-full h-12 mb-4"
      >
        Create Account
      </Button>
      ...
      <p className="text-sm text-center text-gray-600">
        ...
        <span className="text-black underline cursor-pointer ml-2">
          Log in
        </span>
      </p>
    </div>
