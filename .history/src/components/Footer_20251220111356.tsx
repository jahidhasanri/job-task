...
const Footer = () => {
  return (
    <footer className="bg-[#0F59B9]  border-red-400 xl:max-w-360 mx-auto text-white mt-20">
      {/* Top Footer */}
      <div className="  grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1">
        ...
        <div className="xl:w-73.25 xl:mt-29 ">
          ...
          <ul className=" ml-2 text-[14px] opacity-90">
      ...
      {/* Bottom Footer */}
      <div className="text-center py-6 text-[14px] mb-6.5 opacity-90">
