...
const NewArriable = () => {
  ...
  {/* Left Image */}
  <div className="border xl:w-165.5  h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n3 1.png"
      alt=""
      width={662}
  ...
  {/* Right Image */}
  <div className="border xl:w-113  h-full overflow-hidden flex items-center justify-center">
    <Image
      src="/n2 1.png"
      alt=""
      width={452}
